            ...
            <form className="relative z-10 space-y-5 sm:space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" placeholder="John" className="w-full min-w-0 bg-[#020617] border border-white/10 rounded-xl sm:rounded-2xl px-4 sm:px-6 py-3.5 sm:py-4 text-white focus:outline-none focus:border-primaryOrange transition-colors" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-white uppercase tracking-wider">Last Name</label>
                  <input type="text" placeholder="Doe" className="w-full min-w-0 bg-[#020617] border border-white/10 rounded-xl sm:rounded-2xl px-4 sm:px-6 py-3.5 sm:py-4 text-white focus:outline-none focus:border-primaryOrange transition-colors" />
                </div>
              </div>

              <div className="space-y-2">
                <label className="text-sm font-bold text-white uppercase tracking-wider">Email Address</label>
                <input type="email" placeholder="john@company.com" className="w-full min-w-0 bg-[#020617] border border-white/10 rounded-xl sm:rounded-2xl px-4 sm:px-6 py-3.5 sm:py-4 text-white focus:outline-none focus:border-primaryOrange transition-colors" />
              </div>

              <div className="space-y-2">
                <label className="text-sm font-bold text-white uppercase tracking-wider">Subject / Inquiry Type</label>
                <select className="w-full min-w-0 bg-[#020617] border border-white/10 rounded-xl sm:rounded-2xl px-4 sm:px-6 py-3.5 sm:py-4 text-white focus:outline-none focus:border-primaryOrange transition-colors appearance-none">
              ...
              <div className="space-y-2">
                ...
                <textarea rows={5} placeholder="Tell us how we can help you..." className="w-full min-w-0 bg-[#020617] border border-white/10 rounded-xl sm:rounded-2xl px-4 sm:px-6 py-3.5 sm:py-4 text-white focus:outline-none focus:border-primaryOrange transition-colors resize-none"></textarea>
              </div>

              <button type="button" className="w-full inline-flex items-center justify-center gap-2 py-3.5 sm:py-4 bg-gradient-to-r from-primaryOrange to-[#ff7a45] text-white font-black text-sm sm:text-base rounded-xl shadow-lg shadow-primaryOrange/20 transition-all hover:-translate-y-0.5 hover:scale-[1.01] active:scale-95">
